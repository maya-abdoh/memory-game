...
const cardImages = [
  { src: Flower1, matched: false },
  { src: Flower2, matched: false },
  { src: Flower3, matched: false },
  { src: Flower4, matched: false },
  { src: Flower5, matched: false },
  { src: Flower6, matched: false },
];
